    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <ul class="breadcrumb">
          ...
          <li><a href="#">Mes maisons Libres</a></li>
        </ul>
      </div>
    </div>
  </div>
      ...
      <div class="blog-post">
        <section class="jobox">
          <div  class="col-md-12 col-sm-12 col-xs-12">
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="col-md-6 col-xs-12"><a href="?p=bailleur.maisonLibres" class="btn btn-primary">Maisons Libres</a> &nbsp; &nbsp;<a href="?p=bailleur.maisonOccupees" class="btn btn-primary">Maisons Occupées</a></div>
                ...
                <thead>
                  <tr>
                    <th colspan="8" class="text-center">
                      <b>Liste de mes Maisons Libres</b>
                    </th>
                  </tr>
                  <tr>
