...
<div class="container" style="min-height:480px;">
  ...
  <div class="row">
    <div class="col-sm-12 blog-main">
                 ...
                 <?php
                  ...
                  <form method="post" enctype="multipart/form-data" class="form-horizontal" role="form"  onsubmit="return checkCheckBoxes(this);">
                    ...
                    <div class="form-group">
                      <label class="col-md-3 control-label">Nom Locataire</label>
                      <div class="col-md-9">
                          <input type="text" class="form-control" name="nom_locataires" placeholder="Nom de votre locataire">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 control-label">Prenoms locataire</label>
                      <div class="col-md-9">
                          <input type="text" class="form-control" name="prenom_locataires" placeholder="Prenoms de votre loacataire">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 control-label">Phone</label>
                      <div class="col-md-9">
                          <input type="text" class="form-control" name="phone_locataires" placeholder="Phone du locataire">
                      </div>
                    </div>
                    <div class="form-group">
                      <label class="col-md-3 control-label">Mail du locataire</label>
                      <div class="col-md-9">
                          <input type="text" class="form-control" name="mail_locataires" placeholder="Mail du locataire">
                      </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      <label class="col-xs-4 col-sm-3 col-md-3 control-label">Numero de porte attribuee</label>
                      <div class="col-xs-8 col-sm-9 col-md-9">
                        <select class="form-control chosen" name="idmaison">
                          <optgroup label="Maison affectee">
                            <?php 
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-md-offset-3 col-md-9">
                        ...
                        <div class="col-xs-12 col-sm-12 col-md-6">
                          <button id="btn-signup" type="submit" class="btn btn-success btn-block" name="newlocataire"><i class="fa fa-save"></i> Ajouter </button>
                        </div>
                      </div>
                    </div>
                  </form>
      ...
      <nav>
        <a href="?p=bailleur.oldlocataire" class="btn btn-primary">Locataire avec un compte</a>
