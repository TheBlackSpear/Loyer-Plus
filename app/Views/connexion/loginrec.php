...
<div class="container">
  <form class="form-signin" method="post">
    <h2 class="form-signin-heading text-center">CONNEXION BAILLEUR</h2>
   ...
   <!--<div class="checkbox">
    ...
    <br>
    <div class="">
      <a href="?p=bailleur.inscription">Vous n'avez pas de compte.</a>
      <br>
      <a href="?p=bailleur.lostPass"><i> <b>Mot de passe oublié.</b></i></a>
    </div>
  </form>
